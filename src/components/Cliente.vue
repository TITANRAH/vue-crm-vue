...
// como creare un computed property para unir el nombre 
// ahi si requiero poner const props = defineProps
...
const estadoCliente = computed(() => {
    ...
    return props.cliente.estado == true ? 'Activo' : 'Inactivo'
})
    ...
    <tr>
        ...
        <td class="whitespace-nowrap px-3 py-4 text-sm">
            ...
            <button class="inline-flex rounded-full px-2 text-xs font-semibold leading-5"
                :class="[estadoCliente == 'Activo' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800']"
